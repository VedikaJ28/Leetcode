class Solution {
    ...
    public int ladderLength(String sw, String ew, List<String> w) {
        ...
        mp.put(sw, new HashSet<>()); // Ensure start word is included

        // Connect start word with words that differ by one character
        for (String w2 : w) {
        ...
        // Connect every pair of words that differ by one character
